...
class ContactSubmissionAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (_("Contact Information"), {"fields": ("name", "email", "phone")}),
        (_("Investment Details"), {"fields": ("investment_type", "message")}),
        (
            _("Status & Follow-up"),
            {"fields": ("status", "notes", "contacted_at"), "classes": ("wide",)},
        ),
        (
...
class PageViewAdmin(admin.ModelAdmin):
    """
    Admin interface for viewing page analytics
    """
